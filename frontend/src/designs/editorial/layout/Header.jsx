            ...
            >
                <div className="u-container flex h-16 items-center justify-between gap-6 md:h-20">
                    ...
                    <div className="flex items-center gap-4 md:gap-5">
                        ...
                        {/* Returns the visitor to the plain design system. */}
                        <button
                            type="button"
                            onClick={toggleDesign}
                            className="u-tap u-label hidden rounded-full border border-line px-3 py-2 text-faint transition-colors hover:border-line-strong hover:text-ink md:inline-flex"
                        >
                            {meta.switchLabel}
                        </button>
